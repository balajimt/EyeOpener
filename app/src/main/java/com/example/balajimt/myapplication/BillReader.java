...
public class BillReader extends AppCompatActivity {
                ...
                public void surfaceCreated(SurfaceHolder holder) {
                    try {
                        if (ActivityCompat.checkSelfPermission(getApplicationContext(), Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) {
                            ...
                            ActivityCompat.requestPermissions(BillReader.this, new String[]{Manifest.permission.CAMERA}, RequestCameraPermissionID);
...
//       // tts.speak("Recognizing next block",TextToSpeech.QUEUE_FLUSH,null);
